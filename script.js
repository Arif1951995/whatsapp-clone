...
/************
used fetch to complete and then aync/await
both work fine seprately
*/ 
...
async function getDataAW() {
        try {
            let result = await fetch(` https://cors-anywhere.herokuapp.com/https://tk-whatsapp.herokuapp.com/messages`);
